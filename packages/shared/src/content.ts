 ...
 * один класс-заглушка: персонажи с `class_id` есть (T-004), но комната инстанса
 * знает только `sessionId`, поэтому стартовые HP игрока приходят из `/content`,
 * а не из привязанного к соединению персонажа.
 */
